...
- All server setups are done and managed by OPS team - see [Environment Setup Process](https://github.com/threefoldtech/home/blob/master/environment_setup_processes.md).
