...
- [Web Gateway](https://github.com/threefoldtech/tfgateway/)
 - Version: v0.3.7, see [release note](https://github.com/threefoldtech/tfgateway/releases/tag/v0.3.7)
...
- [0-DB](https://github.com/threefoldtech/0-db)
  - Version: v1.0.0, see [release note](https://github.com/threefoldtech/0-db/releases/tag/v1.0.0)
